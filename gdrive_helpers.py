...
_CLIENT_CREDS = ClientCreds(
    client_id = _client_creds_dict['installed']['client_id'],
    client_secret = _client_creds_dict['installed']['client_secret'],
    scopes = _user_creds_dict['scopes'],
    redirect_uri = _client_creds_dict['installed']['redirect_uris'][0]
)
def agg() -> Aiogoogle:
